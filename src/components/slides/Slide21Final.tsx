  ...
  return (
    <SlideContainer>
      <div className="relative z-10 text-center">
          ...
          <div className="relative inline-flex items-center justify-center">
            ...
            <div className="relative animate-glow-pulse">
              <img
                src={fishcakeLogo}
                alt="Fishcake Logo"
                className="w-32 h-32 md:w-36 md:h-36 object-contain drop-shadow-[0_0_40px_rgba(255,200,0,0.6)]"
              />
            </div>
          </div>
        </div>
        ...
        <h1
          className="font-display text-5xl md:text-6xl lg:text-7xl font-bold mb-3 animate-slide-up"
          style={{
        ...
        {/* Tagline with glow */}
        <p
          className="text-2xl md:text-3xl font-display font-bold text-primary mb-8 animate-slide-up"
          style={{
